...
//            $.id(R.id.app_video_loading).visible();
    ...
    public PlayerManager onComplete(Runnable complete) {
    ...
    public PlayerManager onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
